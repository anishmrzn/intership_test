    ...
    <div className="campaign ">
      <div className="campaign-title">
        ...
        <p>
          ...
          help. We<br></br> are working at the national and EU levels to
          advance.
        </p>
      </div>
      <div className="campaign-content">
        <div className="campaign-box">
          <img src="campaign1.jpg" alt="" />
          <div className="campaign-box-contents">
